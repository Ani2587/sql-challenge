...
--Copy the CSV data into their corresponding tables in the specified order

COPY departments FROM '/Users/anitakumar/Resources/departments.csv' WITH CSV HEADER;
COPY titles FROM '/Users/anitakumar/Resources/titles.csv' WITH CSV HEADER;
COPY employees FROM '/Users/anitakumar/Resources/employees.csv' WITH CSV HEADER;
COPY dept_emp FROM '/Users/anitakumar/Resources/dept_emp.csv' WITH CSV HEADER;
COPY dept_manager FROM '/Users/anitakumar/Resources/dept_manager.csv' WITH CSV HEADER;
COPY salaries FROM '/Users/anitakumar/Resources/salaries.csv' WITH CSV HEADER;

--Queries to display the complete data from all tables
